# Generated by Django 4.2.3 on 2023-08-21 03:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geom', django.contrib.gis.db.models.fields.MultiLineStringField(blank=True, geography=True, null=True, srid=3857)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nazwa_gminy', models.CharField(blank=True, max_length=29, null=True)),
                ('data', models.CharField(blank=True, max_length=26, null=True)),
                ('geom', django.contrib.gis.db.models.fields.MultiPolygonField(blank=True, geography=True, null=True, srid=3857)),
                ('area', models.FloatField(db_index=True)),
            ],
            options={
                'db_table': 'pl_plot3857',
                'managed': True,
                'indexes': [models.Index(fields=['area'], name='pl_plot3857_area_748ae0_idx'), models.Index(fields=['geom'], name='idx_plplot_geom'), models.Index(fields=['geom'], name='idx_plplot_geom_spatial')],
            },
        ),
    ]
